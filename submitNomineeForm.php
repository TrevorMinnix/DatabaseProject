...
if(isset($_POST['submitNomineeForm'])){
	...
	$updateNominee = "INSERT INTO gtanominee 	(advisor, nomineePhone, semestersAsGrad, passedSpeak, semestersAsGTA, gradCourses, gpa, publications, pid)
								VALUES 			('$advisorName', '$nomineePhone',$numberOfSemAsGTA,$isNomineePassedSpeak,$numberOfSemAsGTA,'$coursesCompleted',$coursesGPA, '$publications', '$nomineePid')";
	//Execute the query
